...
function Detail() {
  ...
  const addToCart = () => {
    ...
    if (itemInCart) {
      ...
      // if were updating quantity, use existing item data and icrement purchaseQuantity value by one
      idbPromise('cart', 'put', {
        ...itemInCart,
        purchaseQuantity: parseInt(itemInCart.purchaseQuantity) + 1
      });
      ...
      // if product isnt in the cart yet, add it to current shopping cart in indexedDB
